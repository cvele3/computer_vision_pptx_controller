...
WORKFLOWS = [
    ["PRESENTATION_MODE_ON", "NEXT_SLIDE", "NEXT_SLIDE", "PREVIOUS_SLIDE", "NEXT_SLIDE", "PRESENTATION_MODE_OFF"],
    ["PRESENTATION_MODE_ON", "PLAY_VIDEO", "STOP_VIDEO", "NEXT_SLIDE", "PRESENTATION_MODE_OFF"],
    ["PRESENTATION_MODE_ON", "QUESTION_BLOCK", "NEXT_SLIDE", "PREVIOUS_SLIDE", "STOP_VIDEO", "PRESENTATION_MODE_OFF"]
]
